  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm text-center">
        ...
        <p className="text-gray-400 text-sm mb-10">Keep your diary chocka</p>

        <div className="bg-white rounded-2xl border-2 border-gray-100 p-8">
          <h2 className="text-xl font-bold text-charcoal mb-2">Get started</h2>
          <p className="text-sm text-gray-400 mb-8">
            Connect your Google account to manage your business profile automatically.
          </p>

          <Button onClick={handleGoogleLogin} variant="secondary" size="lg" className="w-full">
